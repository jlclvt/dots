...
-- Theme Definition {{{
local theme = {}
theme.dir = os.getenv("HOME").."/.config/awesome/themes/wp/"
...
theme.bg_normal = '#15181a' -- '#1e222a'
theme.bg_focus = '#121622'
theme.bg_urgent = "#081218"
theme.bg_light = '#1e222a' -- '#2c3038'
...
function theme.at_screen_connect(s)
	gears.wallpaper.tiled(theme.dir.."/2021-10-11_19-18.png", s)
