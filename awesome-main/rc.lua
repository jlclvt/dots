...
beautiful.init(string.format("%s/.config/awesome/themes/%s/theme.lua", os.getenv("HOME"), "wp"))
...
globalkeys = gears.table.join(
    ...
    awful.key({ }, "Print", function () awful.spawn("flameshot gui") end),
       ...
       awful.util.spawn("backlight_control +10") end),
    awful.key({ }, "XF86MonBrightnessDown", function ()
       awful.util.spawn("backlight_control -10") end),

       awful.key({ }, "XF86AudioRaiseVolume", function ()
       awful.util.spawn("pamixer -i +5") beautiful.update_volume() end),
    awful.key({ }, "XF86AudioLowerVolume", function ()
       awful.util.spawn("pamixer -d 5") beautiful.update_volume() end),
    awful.key({ }, "XF86AudioMute", function ()
       awful.util.spawn("pamixer -t") beautiful.update_volume() end),
    ...
    awful.key({ modkey, "Shift" }, "c", function () awful.layout.set(awful.layout.suit.max)                end,
              {description = "monocle mode", group = "layout"}),
    awful.key({ modkey   }, "c", function () awful.layout.set(awful.layout.suit.floating)                end,
